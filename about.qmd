...
The KROEG Index is published under the GNU General Public License v2.0 (GPL-2.0). This open-source license permits anyone to use, study, modify, and redistribute the software, provided that any distributed modifications or derivative works are also released under the GPL-2.0 license. The GPL-2.0 is designed to ensure that the software and its source code remain freely available to the community.

## Suggested Citation

Florschütz, Tim, Aidan Kloots, and Till Hovestadt. ‘The KROEG Index - Kaart van Ruimtelijke Ontmoetingsplekken en Externe Gemeenschap in Nederland’. Zenodo, 18 June 2026. https://doi.org/10.5281/zenodo.20748479.
